...
//tempOprij=getIntent().getParcelableExtra("opPrij");
        ...
        displayValues(wiper,ponPoffStrs,tlgAbstrs,strLoadMngs,m_PProg_R1,m_PProg_R2,m_PProg_R3,m_PProg_R4,oprij);
    ...
    private void displayValues(Wiper [] wiper,PonPoffStr[] ponPoffStr,TlgAbstr[] tlgAbstrs,StrLoadMng[] strLoadMng,Opprog [] m_PProg_R1,Opprog [] m_PProg_R2,Opprog [] m_PProg_R3,Opprog [] m_PProg_R4,Oprij oprij) {
        ...
        tableLayout.addView(switchDelayColumns);
        ...
        for (int i = 0; i < 4; i++) {
            tableLayout.addView(switchDelayTR[i]);
    ...
    private String UnPackLadderSTR(int rel, int PCCNFG) {
        ...
        private void GetRelAkProg(int brrel){
            ...
            for (int pItem=0;pItem<16;pItem++){
                ...
                switch (brrel){
                    case 1:
                        ...
                        tableLayout.addView(relAkProgTR[pItem]);
                        break;
                    case 2:
...
*/
    ...
    public void DisplayGeneral(){
        ...
        switch (m_HWVerPri){
            case TIP_S:	   str="S"; break;
            case TIP_SN:   str="SN"; break;
            case TIP_SPA:  str="SPA";break;
            case TIP_PAS:  str="PAS";break;
            case TIP_PA:   str="PA";break;
            case TIP_PASN: str="PASN";break;
            case TIP_SPN:  str="SPN";break;
            case TIP_PS:  str = "PS"; break;
